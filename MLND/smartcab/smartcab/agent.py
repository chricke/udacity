...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5):
        ...
        self.epsilon_decay_factor = 0.95
        self.T = 0
    ...
    def build_state(self):
        ...
        # constraints in order for you to learn how to adjust epsilon and alpha, and thus learn about the balance
    ...
    def choose_action(self, state):
        ...
        if (not self.learning) or (self.epsilon > random.random()):
            ...
            for state_action in self.Q[state]:
                if maxQ == self.Q[state][state_action]:
                    valid_actions.append(state_action)
